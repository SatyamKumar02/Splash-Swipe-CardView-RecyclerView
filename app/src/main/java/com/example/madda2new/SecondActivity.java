...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerDataArrayList.add(new RecyclerData("DSA Course", "DSA Self Paced Course", R.drawable.dsa));
        recyclerDataArrayList.add(new RecyclerData("C++ Course", "C++ Self Paced Course", R.drawable.cpp));
        recyclerDataArrayList.add(new RecyclerData("Java Course", "Java Self Paced Course", R.drawable.java));
        recyclerDataArrayList.add(new RecyclerData("Python Course", "Python Self Paced Course", R.drawable.python));
        recyclerDataArrayList.add(new RecyclerData("Fork CPP", "Fork CPP Self Paced Course", R.drawable.forkcpp));
        recyclerDataArrayList.add(new RecyclerData("Amazon SDE", "Amazon SDE Test Questions", R.drawable.amazonsde));
